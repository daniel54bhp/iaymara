...
/* ───────────────── ChatScreen ───────────────── */
class ChatScreenMat extends StatefulWidget {
  const ChatScreenMat({
    super.key,
  ...
  @override
  State<ChatScreenMat> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<ChatScreenMat> {
  /* Gemma */
  ...
  Future<void> _initGemma(String path) async {
    ...
    await _chat.addQueryChunk(
      Message.text(
        isUser: false,
        text:
            'Actuaras como un profesor experto en Matemáticas'
