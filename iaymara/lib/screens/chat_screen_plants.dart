...
/* ───────────────── ChatScreen ───────────────── */
class ChatScreenPlants extends StatefulWidget {
  const ChatScreenPlants({
    super.key,
  ...
  @override
  State<ChatScreenPlants> createState() => _ChatScreenState();
}

class _ChatScreenState extends State<ChatScreenPlants> {
  /* Gemma */
  ...
  Future<void> _initGemma(String path) async {
    ...
    await _chat.addQueryChunk(
      Message.text(
        isUser: false,
        text:
            'Eres un experto en el cuidado de plantas'
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Chat Cuidado de Plantas')),
      body: Column(
        children: [
          Container(
